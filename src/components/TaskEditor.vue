...
export default {
    ...
    data() {
        return {
            ...
            colorPalette: ['#ff7f50', '#87cefa', '#da70d6', '#32cd32', '#6495ed', '#ff69b4', '#ba55d3', '#cd5c5c', '#ffa500', '#40e0d0'],
            taskInfo: {}
        }
    },
    watch: {
    ...
    methods: {
        requirementsCheck() {
            ...
            return this.selectedTimeStart < this.selectedTimeEnd;
        },
        newTask() {
...
<template>
    <div class="taskList">
        ...
        <div class="formContainer" v-if="!hasTasksEditor || showTaskEdit">
            ...
            <button @click="showColorPalette = !showColorPalette" :style="{ background: taskColor }">Pick
                color
            </button>
            <br>
            <!--- Spalvų paletė --->
            ...
            <textarea id="tdesc" v-model="tDesc"></textarea><br>
        ...
        <div v-else>
            ...
            <template v-if="taskInfo.taskStatus === 'ongoing'">
                <button type="button" @click="$emit('finishTheTask', taskInfo.id)">Finish task</button>
                <br><br>
                <button type="button" @click="showEditScreen()">Edit task</button>
                <br><br>
            </template>
